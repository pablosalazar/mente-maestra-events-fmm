...
export type Department = (typeof colombianRegions)[number]["departamento"];

export const DEPARTMENTS = [
  ...new Set(colombianRegions.map((r) => r.departamento)),
].sort() as Department[];

export const MUNICIPALITIES_BY_DEPARTMENT = Object.fromEntries(
  colombianRegions.map((r) => [r.departamento, [...new Set(r.ciudades)].sort()])
